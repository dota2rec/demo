...
export const ITEM_DESC = { blink:
   ...
   javelin:
    { id: 7,
      ...
      qual: 'component',
      cost: 1100,
      desc: '<h1>Passive: Pierce</h1>Grants each attack a 25% chance to pierce through evasion and deal 100 bonus damage.',
      notes: '',
      attrib: '',
      mc: false,
      cd: false,
   ...
   quelling_blade:
    { id: 11,
      ...
      qual: 'component',
      cost: 200,
      desc: '<h1>Active: Chop Tree/Ward</h1> Destroy a target tree or ward. Chop cast range is increased when targeting wards.<br><br>Tree Range: 350<BR>Ward Range: 450<br />\r\n<h1>Passive: Quell</h1> Increases attack damage against non-hero units by 24 for melee heroes, and 7 for ranged.',
      notes: 'Cannot carry more than one.<br />Chop can be used to destroy Techies\' Remote Mines.',
      attrib: '',
      mc: false,
      cd: 4,
   ...
   faerie_fire:
    { id: 237,
      ...
      qual: 'consumable',
      cost: 70,
      desc: '<h1>Use: Imbue</h1> Instantly restores 85 HP.',
      notes: '',
   ...
   infused_raindrop:
    { id: 265,
      ...
      qual: 'component',
      cost: 225,
      desc: '<h1>Passive: Magical Damage Block</h1> Consumes a charge to block 120 magic damage from damage instances over 50 damage. <br><br>Comes with 5 charges. When the charges are gone, the item disappears.',
      notes: 'Uses at most one charge per damage instance.',
      attrib: '+ <span class="attribVal">0.5</span> <span class="attribValText">Mana Regeneration</span>',
      mc: false,
      cd: 7,
   ...
   wind_lace:
    { id: 244,
      ...
      qual: 'component',
      cost: 250,
      desc: 'Bonuses from multiple Wind Laces do not stack.',
      notes: '',
   ...
   stout_shield:
    { id: 182,
      ...
      qual: 'component',
      cost: 200,
      desc: '<h1>Passive: Damage Block</h1>Gives a 50% chance to block 18 damage on melee heroes, and 9 damage on ranged.',
   ...
   moon_shard:
    { id: 247,
      ...
      qual: 'consumable',
      cost: 4000,
      desc: '<h1>Use: Consume</h1> Consume the Moon Shard to permanently gain 60 attack speed and 150 bonus night vision. Max 1 use.<br />\r\n<h1>Passive: Shade Sight</h1>Grants 300 bonus night vision.',
      notes: 'The bonus night vision works during Night Stalker\'s Darkness ability.',
      attrib: '+ <span class="attribVal">130</span> <span class="attribValText">Attack Speed</span>',
      mc: false,
      cd: false,
   ...
   branches:
    { id: 16,
      ...
      qual: 'consumable',
      cost: 50,
      desc: '<h1>Use: Plant Tree</h1> Targets the ground to plant a happy little tree that lasts for 20 seconds.<br><br>Range: 200',
      notes: '',
   ...
   lifesteal:
    { id: 26,
      ...
      qual: 'component',
      cost: 1100,
      desc: '<h1>Passive: Lifesteal</h1>Heals the attacker for 15% of attack damage dealt.',
      notes: '',
      attrib: '+ <span class="attribVal">10</span> <span class="attribValText">Damage</span>',
      mc: false,
      cd: false,
   ...
   ring_of_regen:
    { id: 27,
      ...
      attrib: '+ <span class="attribVal">1.5</span> <span class="attribValText">HP Regeneration</span>',
      mc: false,
      cd: false,
   ...
   boots:
    { id: 29,
      ...
      notes: '',
      attrib: '+ <span class="attribVal">50</span> <span class="attribValText">Movement Speed</span>',
      mc: false,
      cd: false,
   ...
   talisman_of_evasion:
    { id: 32,
      ...
      attrib: '+ <span class="attribVal">20%</span> <span class="attribValText">Evasion</span>',
      mc: false,
      cd: false,
   ...
   cheese:
    { id: 33,
      ...
      qual: 'consumable',
      cost: 1000,
      desc: '<h1>Use: Fondue</h1> Instantly restores 2500 health and 1500 mana.',
   ...
   magic_stick:
    { id: 34,
      ...
      qual: 'component',
      cost: 200,
      desc: '<h1>Active: Energy Charge</h1> Instantly restores 15 health and mana per charge stored.<br><br> Max 10 charges. Gains a charge whenever a visible enemy within 1200 range uses an ability.',
   ...
   magic_wand:
    { id: 36,
      ...
      qual: 'common',
      cost: 400,
      desc: '<h1>Active: Energy Charge</h1>Instantly restores 15 health and mana per charge stored. <br><br>Max 17 charges. Gains a charge whenever a visible enemy within 1200 range uses an ability.',
      notes: 'Gains charges for spells cast by visible enemies in 1200 range.<br />Certain abilities and item abilities will not add charges.',
      attrib: '+ <span class="attribVal">2</span> <span class="attribValText">All Attributes</span><br />\n+ <span class="attribVal">1.5</span> <span class="attribValText">HP Regeneration</span>',
      mc: false,
      cd: 13,
      lore: 'A simple wand used to channel magic energies, it is favored by apprentice wizards and great warlocks alike.',
      components: [ 'magic_stick', 'branches', 'branches', 'enchanted_mango' ],
      created: true },
   ghost:
    { id: 37,
      img: 'ghost_lg.png?3',
      ...
      qual: 'component',
      cost: 1500,
      desc: '<h1>Active: Ghost Form</h1> You enter ghost form for 4 seconds, becoming immune to physical damage, but are unable to attack and 40% more vulnerable to magic damage.',
   ...
   clarity:
    { id: 38,
      ...
      qual: 'consumable',
      cost: 50,
      desc: '<h1>Use: Replenish</h1> Grants 3 mana regeneration to the target for 50 seconds.<br><br>If the unit is attacked by an enemy hero or Roshan, the effect is lost.<br><br>Range: 250',
      notes: '',
      attrib: '',
      mc: false,
      cd: false,
   ...
   enchanted_mango:
    { id: 216,
      ...
      qual: 'consumable',
      cost: 100,
      desc: '<h1>Use: Eat Mango</h1> Instantly restore 175 mana.<br><br>Range: 400',
      notes: 'Hold Control to use on a nearby allied hero.',
      attrib: '+ <span class="attribVal">1</span> <span class="attribValText">HP Regeneration</span>',
      mc: false,
      cd: false,
   ...
   flask:
    { id: 39,
      ...
      qual: 'consumable',
      cost: 110,
      desc: '<h1>Use: Salve</h1> Grants 50 health regeneration to the target for 8 seconds.<br><br>If the unit is attacked by an enemy hero or Roshan, the effect is lost.<br><br>Range: 250',
      notes: '',
      attrib: '',
      mc: false,
      cd: false,
   ...
   bottle:
    { id: 41,
      ...
      qual: 'common',
      cost: 650,
      desc: '<h1>Active: Regenerate</h1>Consumes a charge to restore 80 health and 40 mana over 2.5 seconds.<br><br>Range: 350<br><br>Healing stops if attacked by an enemy hero or Roshan.  Bottle can be refilled at your team\'s fountain. Runes can be stored in the Bottle for later use, and are activated automatically after 2 minutes.',
      notes: 'Bottle is shareable. Stored runes cannot be shared. Hold Control to use Regenerate on an allied hero.<br />Bounty runes replenish 2/3 charges.<br />If Bottle does not have full charges and is placed on a courier, the courier will move 30% slower.',
      attrib: '',
      mc: false,
      cd: 0,
   ...
   ward_sentry:
    { id: 43,
      ...
      qual: 'consumable',
      cost: 100,
      desc: '<h1>Use: Plant</h1> Plants a Sentry Ward, an invisible watcher that grants True Sight, the ability to see invisible enemy units and wards, to any existing allied vision within a 850 radius.<br>Duration: 4 minutes.<br><br>Does not grant ground vision.<br>Hold Control to give one Sentry Ward to an allied hero.<br><br>Range: 500',
      notes: '',
      attrib: '',
      mc: false,
      cd: 1,
   ...
   ward_dispenser:
    { id: 218,
      ...
      qual: 'common',
      cost: 180,
      desc: '<h1>Use: Plant</h1> Plant the currently active ward.  Double-Click to switch the currently active ward.<br><br>Range: 500',
      notes: '',
   ...
   tango:
    { id: 44,
      ...
      qual: 'consumable',
      cost: 90,
      desc: '<h1>Use: Devour</h1> Consume a target tree to gain 7 health regeneration for 16 seconds. Consuming a ward or Ironwood Tree doubles the heal amount.<br><br>Comes with 3 charges.  Can be used on an allied hero to give them one Tango.<br><br>Range: 165<br>Ward Range: 450',
      notes: '',
      attrib: '',
      mc: false,
      cd: false,
   ...
   tango_single:
    { id: 241,
      ...
      qual: 'consumable',
      cost: 30,
      desc: '<h1>Use: Devour</h1> Consume a target tree to gain 7 health regeneration for 16 seconds. Consuming a ward or Ironwood Tree doubles the heal amount.<br><br>Range: 165<br>Ward Range: 450',
      notes: '',
      attrib: '',
      mc: false,
      cd: 60,
   ...
   travel_boots:
    { id: 48,
      ...
      qual: 'common',
      cost: 2500,
      desc: '<h1>Active: Teleport</h1>Teleports you to an allied non-hero unit or structure. Teleporting to a unit is interrupted if the target unit dies.<br><br>Shares a cooldown with Town Portal Scroll.<br><br>Flat movement speed bonuses from multiple pairs of boots do not stack.',
      notes: '',
   ...
   travel_boots_2:
    { id: 220,
      ...
      qual: 'common',
      cost: 4500,
      desc: '<h1>Active: Teleport</h1> Teleports you to any allied structure or unit, including heroes. Teleporting to a unit is interrupted if the target unit dies.<br><br>Shares a cooldown with Town Portal Scroll.<br><br>Flat movement speed bonuses from multiple pairs of boots do not stack.',
      notes: '',
      attrib: '+ <span class="attribVal">100</span> <span class="attribValText">Movement Speed</span>',
      mc: 75,
      cd: 45,
   ...
   phase_boots:
    { id: 50,
      ...
      qual: 'common',
      cost: 1340,
      desc: '<h1>Active: Phase</h1> Gives 24% increased movement speed on melee heroes, and 20% on ranged heroes, and lets you move through units for 2.5 seconds.<br><br>Flat movement speed bonuses from multiple pairs of boots do not stack.',
      notes: '',
   ...
   ring_of_health:
    { id: 56,
      ...
      attrib: '+ <span class="attribVal">5</span> <span class="attribValText">HP Regeneration</span>',
      mc: false,
      cd: false,
   ...
   void_stone:
    { id: 57,
      ...
      attrib: '+ <span class="attribVal">1</span> <span class="attribValText">Mana Regeneration</span>',
      mc: false,
      cd: false,
   ...
   power_treads:
    { id: 63,
      ...
      qual: 'common',
      cost: 1450,
      desc: '<h1>Active: Switch Attribute</h1>Switches between +10 Strength, +10 Agility, or +10 Intelligence.<br><br>Flat movement speed bonuses from multiple pairs of boots do not stack.',
      notes: 'Power Treads can be built using a Belt of Strength, Band of Elvenskin, or a Robe of the Magi.<br />The attack speed bonus from multiple Power Treads does not stack.',
   ...
   hand_of_midas:
    { id: 65,
      ...
      qual: 'common',
      cost: 2150,
      desc: '<h1>Active: Transmute</h1> Kills a non-hero target for 200 gold and 1.85x experience. <br><br> Cannot be used on Ancient Creeps.<br><br>Range: 600',
      ...
      attrib: '+ <span class="attribVal">30</span> <span class="attribValText">Attack Speed</span>',
      mc: false,
      cd: 100,
   ...
   pers:
    { id: 69,
      ...
      attrib: '+ <span class="attribVal">5.5</span> <span class="attribValText">HP Regeneration</span><br />\n+ <span class="attribVal">1.5</span> <span class="attribValText">Mana Regeneration</span>',
      mc: false,
      cd: false,
   ...
   poor_mans_shield:
    { id: 71,
      ...
      qual: 'common',
      cost: 0,
      desc: '<h1>Passive: Damage Block</h1>When cooldown is ready, blocks 30 damage on melee heroes and 15 on ranged heroes. Only triggers on attacks from heroes. <br><br>Gives a 50% chance to block 18 damage on melee heroes, and 9 damage on ranged.',
      notes: 'Multiple sources of damage block don\'t stack.',
      attrib: '+ <span class="attribVal">6</span> <span class="attribValText">Agility</span>',
      mc: false,
      cd: 25,
   ...
   bracer:
    { id: 73,
      ...
      desc: '',
      notes: '',
      attrib: '+ <span class="attribVal">7</span> <span class="attribValText">Strength</span><br />\n+ <span class="attribVal">3</span> <span class="attribValText">Agility</span><br />\n+ <span class="attribVal">3</span> <span class="attribValText">Intelligence</span>',
      mc: false,
      cd: false,
   ...
   null_talisman:
    { id: 77,
      ...
      desc: '',
      notes: '',
      attrib: '+ <span class="attribVal">3</span> <span class="attribValText">Strength</span><br />\n+ <span class="attribVal">3</span> <span class="attribValText">Agility</span><br />\n+ <span class="attribVal">7</span> <span class="attribValText">Intelligence</span>',
      mc: false,
      cd: false,
   ...
   mekansm:
    { id: 79,
      ...
      qual: 'rare',
      cost: 2350,
      desc: '<h1>Active: Restore</h1>Heals 250 health and gives +2 armor to allied units in a 900 radius.<br />\r\n<h1>Passive: Mekansm Aura</h1>Grants 3.5 health regeneration to allied units in a 900 radius.',
   ...
   vladmir:
    { id: 81,
      ...
      qual: 'rare',
      cost: 2250,
      desc: '<h1>Passive: Vladmir\'s Aura</h1>Grants lifesteal (15% for melee heroes, 10% for ranged), 2.5 health regeneration, 0.65 mana regeneration, 15% bonus attack damage, and 4 armor to nearby allies. <br><br>Radius: 900',
   ...
   buckler:
    { id: 86,
      ...
      qual: 'rare',
      cost: 800,
      desc: '<h1>Active: Armor Bonus</h1> Gives +2 armor to all allied units.  Lasts 25 seconds on heroes, 30 seconds on units.<br><br>Radius: 900',
      notes: '',
   ...
   ring_of_basilius:
    { id: 88,
      ...
      qual: 'rare',
      cost: 500,
      desc: '<h1>Passive: Basilius Aura</h1>Grants 0.5 mana regeneration and 2 armor in a 900 radius.<br />\r\n<h1>Toggle: Aura</h1>Deactivate aura to stop effecting non-hero units.',
   ...
   pipe:
    { id: 90,
      ...
      qual: 'rare',
      cost: 3150,
      desc: '<h1>Active: Barrier</h1>Gives a shield that blocks 400 magic damage to all nearby allies. Lasts 12 seconds.<br><br>Radius: 900<br />\r\n<h1>Passive: Insight Aura</h1> Gives allied units 2 health regeneration and 10% magic resistance.<br><br>Radius: 900',
      notes: 'Multiple instances of Barrier do not stack.<br />Stacks multiplicatively with other sources of magic resistance.',
      attrib: '+ <span class="attribVal">6.5</span> <span class="attribValText">HP Regeneration</span><br />\n+ <span class="attribVal">30%</span> <span class="attribValText">Magic Resistance</span>',
      mc: 100,
      cd: 60,
   ...
   urn_of_shadows:
    { id: 92,
      ...
      qual: 'rare',
      cost: 875,
      desc: '<h1>Active: Soul Release</h1> Provides 35 health regeneration when cast on allies, and deals 25 damage per second when cast on enemies. <br><br>Lasts 8 seconds.  <br><br>Gains charges every time an enemy hero dies within 1400 units.  Only the closest Urn to the dying hero will gain a charge.<br><br>Cast Range: 950',
   ...
   headdress:
    { id: 94,
      ...
      qual: 'rare',
      cost: 650,
      desc: '<h1>Passive: Regeneration Aura</h1>Grants 2 health regeneration to allies.<br><br>Radius: 900',
   ...
   sheepstick:
    { id: 96,
      ...
      qual: 'rare',
      cost: 5700,
      desc: '<h1>Active: Hex</h1>Turns a target unit into a harmless critter for 3.5 seconds. The target has a base movement speed of 140 and will be silenced, muted, and disarmed.<br>Instantly destroys illusions.<br><br>Range: 800',
   ...
   orchid:
    { id: 98,
      ...
      qual: 'rare',
      cost: 4075,
      desc: '<h1>Active: Soul Burn</h1>Silences the target unit for 5 seconds. At the end of the silence, 30% of the damage received while silenced is inflicted as bonus magical damage.<br><br>Range: 900',
      notes: '',
   ...
   bloodthorn:
    { id: 250,
      ...
      qual: 'epic',
      cost: 7195,
      desc: '<h1>Active: Soul Rend</h1> Silences a target for 5 seconds. At the end of the silence, an additional 30% of all damage taken during the silence will be dealt to the target as magic damage.<br>Range: 900<br><br>All attacks on the silenced target will have True Strike and 100% chance to crit for 140% damage.<br />\r\n<h1>Passive: Critical Strike</h1> Grants a 20% chance for attacks to inflict 175% damage.',
   ...
   echo_sabre:
    { id: 252,
      ...
      qual: 'artifact',
      cost: 2650,
      desc: '<h1>Passive: Echo Strike</h1> Causes melee attacks to attack twice in quick succession. The double attacks apply a 100% movement slow for 0.7 seconds on each strike.',
      notes: '',
   ...
   cyclone:
    { id: 100,
      ...
      attrib: '+ <span class="attribVal">10</span> <span class="attribValText">Intelligence</span><br />\n+ <span class="attribVal">2.25</span> <span class="attribValText">Mana Regeneration</span><br />\n+ <span class="attribVal">40</span> <span class="attribValText">Movement Speed</span>',
      mc: 175,
      cd: 23,
   ...
   aether_lens:
    { id: 232,
      ...
      qual: 'rare',
      cost: 2350,
      desc: '<h1>Passive: Aethereal Focus</h1> Increases targeted spell and item cast range by 250.',
   ...
   force_staff:
    { id: 102,
      ...
      qual: 'rare',
      cost: 2250,
      desc: '<h1>Active: Force</h1>Pushes any target unit 600 units in the direction it is facing.<br><br>Range: 750',
      ...
      components: [ 'staff_of_wizardry', 'ring_of_health' ],
      created: true },
   hurricane_pike:
    { id: 263,
      ...
      qual: 'epic',
      cost: 4615,
      desc: '<h1>Active: Hurricane Thrust</h1> Pushes you and target enemy 450 units away from each other, and for 5 seconds, allows you to make 4 attacks against the target without range restrictions and with +100 attack speed.<br><br>Works like Force Staff when used on self or allies.<br><br>Allied Range: 800<br>Enemy Range: 400<br />\r\n<h1>Passive:  Dragon\'s Reach</h1> Increases attack range of ranged heroes by 140.',
   ...
   dagon:
    { id: 104,
      ...
      qual: 'rare',
      cost: 2715,
      desc: '<h1>Active: Energy Burst</h1> Emits a powerful burst of magical damage upon a targeted enemy unit. Upgradable.<br><br>Damage: 400<br>Range: 600<br>Mana Cost: 180',
      notes: 'Instantly kills illusions.',
      attrib: '+ <span class="attribVal">15</span>/18/21/24/27 <span class="attribValText">Intelligence</span><br />\n+ <span class="attribVal"><span class="attribVal">3</span></span> <span class="attribValText">All Attributes</span>',
      mc: 180,
      cd: 35,
   ...
   dagon_2:
    { id: 201,
      ...
      desc: '<h1>Active: Energy Burst</h1> Emits a powerful burst of magical damage upon a targeted enemy unit. Upgradable.<br><br>Damage: 400<br>Range: 600<br>Mana Cost: 180',
      notes: 'Instantly kills illusions.',
      attrib: '+ 15/<span class="attribVal">18</span>/21/24/27 <span class="attribValText">Intelligence</span><br />\n+ <span class="attribVal">3</span> <span class="attribValText">All Attributes</span>',
      mc: 180,
      cd: 35,
      lore: 'A lesser wand that grows in power the longer it is used, it brings magic to the fingertips of the user.',
   ...
   dagon_3:
    { id: 202,
      ...
      desc: '<h1>Active: Energy Burst</h1> Emits a powerful burst of magical damage upon a targeted enemy unit. Upgradable.<br><br>Damage: 400<br>Range: 600<br>Mana Cost: 180',
      notes: 'Instantly kills illusions.',
      attrib: '+ 15/18/<span class="attribVal">21</span>/24/27 <span class="attribValText">Intelligence</span><br />\n+ <span class="attribVal">3</span> <span class="attribValText">All Attributes</span>',
      mc: 180,
      cd: 35,
      lore: 'A lesser wand that grows in power the longer it is used, it brings magic to the fingertips of the user.',
   ...
   dagon_4:
    { id: 203,
      ...
      desc: '<h1>Active: Energy Burst</h1> Emits a powerful burst of magical damage upon a targeted enemy unit. Upgradable.<br><br>Damage: 400<br>Range: 600<br>Mana Cost: 180',
      notes: 'Instantly kills illusions.',
      attrib: '+ 15/18/21/<span class="attribVal">24</span>/27 <span class="attribValText">Intelligence</span><br />\n+ <span class="attribVal">3</span> <span class="attribValText">All Attributes</span>',
      mc: 180,
      cd: 35,
      lore: 'A lesser wand that grows in power the longer it is used, it brings magic to the fingertips of the user.',
   ...
   dagon_5:
    { id: 204,
      ...
      qual: 'rare',
      cost: 7715,
      desc: '<h1>Active: Energy Burst</h1> Emits a powerful burst of magical damage upon a targeted enemy unit.<br><br>Damage: 400<br>Range: 600<br>Mana Cost: 180',
      notes: 'Instantly kills illusions.',
      attrib: '+ 15/18/21/24/<span class="attribVal">27</span> <span class="attribValText">Intelligence</span><br />\n+ <span class="attribVal">3</span> <span class="attribValText">All Attributes</span>',
      mc: 180,
      cd: 35,
      lore: 'A lesser wand that grows in power the longer it is used, it brings magic to the fingertips of the user.',
   ...
   necronomicon:
    { id: 106,
      ...
      qual: 'rare',
      cost: 2400,
      desc: '<h1>Active: Demonic Summoning</h1>Summons a Warrior and an Archer to fight for you for 50 seconds.<br><br><h1>Warrior:</h1>Burns mana every hit, and deals magical damage to whoever kills it.  Gains True Sight at level 3.<br>Health: 700<br>Damage: 75<br>Mana Break Damage: 30<br>Last Will Damage: 550<br><br><h1>Archer:</h1>Has a passive movement and attack speed aura. Gains Purge at Level 3.<br>Health: 700<br>Damage: 60<br>Aura Move Speed: 5<br>Aura Attack Speed: 5<br>Aura Radius: 900',
      notes: '',
      attrib: '+ <span class="attribVal">10</span>/15/20 <span class="attribValText">Strength</span><br />\n+ <span class="attribVal">1</span>/1.25/1.5 <span class="attribValText">Mana Regeneration</span>',
      mc: 50,
      cd: 90,
   ...
   necronomicon_2:
    { id: 193,
      ...
      desc: '<h1>Active: Demonic Summoning</h1>Summons a Warrior and an Archer to fight for you for 50 seconds.<br><br><h1>Warrior:</h1>Burns mana every hit, and deals magical damage to whoever kills it.  Gains True Sight at level 3.<br>Health: 700<br>Damage: 75<br>Mana Break Damage: 30<br>Last Will Damage: 550<br><br><h1>Archer:</h1>Has a passive movement and attack speed aura. Gains Purge at Level 3.<br>Health: 700<br>Damage: 60<br>Aura Move Speed: 5<br>Aura Attack Speed: 5<br>Aura Radius: 900',
      notes: '',
      attrib: '+ 10/<span class="attribVal">15</span>/20 <span class="attribValText">Strength</span><br />\n+ 1/<span class="attribVal">1.25</span>/1.5 <span class="attribValText">Mana Regeneration</span>',
      mc: 50,
      cd: 90,
      lore: 'Considered the ultimate in necromancy and demonology, a powerful malefic force is locked within its pages.',
   ...
   necronomicon_3:
    { id: 194,
      ...
      desc: '<h1>Active: Demonic Summoning</h1>Summons a Warrior and an Archer to fight for you for 50 seconds.<br><br><h1>Warrior:</h1>Burns mana every hit, and deals magical damage to whoever kills it.  Gains True Sight at level 3.<br>Health: 700<br>Damage: 75<br>Mana Break Damage: 30<br>Last Will Damage: 550<br><br><h1>Archer:</h1>Has a passive movement and attack speed aura. Gains Purge at Level 3.<br>Health: 700<br>Damage: 60<br>Aura Move Speed: 5<br>Aura Attack Speed: 5<br>Aura Radius: 900',
      notes: '',
      attrib: '+ 10/15/<span class="attribVal">20</span> <span class="attribValText">Strength</span><br />\n+ 1/1.25/<span class="attribVal">1.5</span> <span class="attribValText">Mana Regeneration</span>',
      mc: 50,
      cd: 90,
      lore: 'Considered the ultimate in necromancy and demonology, a powerful malefic force is locked within its pages.',
   ...
   ultimate_scepter:
    { id: 108,
      ...
      qual: 'rare',
      cost: 4200,
      desc: '<h1>Passive: Ultimate Upgrade</h1>Upgrades the ultimate, and some abilities, of certain heroes.',
      notes: '',
   ...
   refresher:
    { id: 110,
      ...
      qual: 'rare',
      cost: 5200,
      desc: '<h1>Active: Reset Cooldowns</h1>Resets the cooldowns of all your items and abilities.',
      notes: '',
      attrib: '+ <span class="attribVal">11</span> <span class="attribValText">HP Regeneration</span><br />\n+ <span class="attribVal">5</span> <span class="attribValText">Mana Regeneration</span>',
      mc: 375,
      cd: 195,
   ...
   assault:
    { id: 112,
      ...
      qual: 'epic',
      cost: 5250,
      desc: '<h1>Passive: Assault Aura</h1> Grants 25 attack speed and 5 armor to nearby allied units and structures, and decreases nearby enemy unit and structure armor by 5.<br><br>Radius: 900',
   ...
   heart:
    { id: 114,
      ...
      qual: 'epic',
      cost: 5200,
      desc: '<h1>Passive: Health Regeneration</h1>Restores 7% of max health per second. <br><br>If damage is taken from an enemy hero or Roshan, this ability is disabled for 5 seconds for melee heroes, or 7 seconds for ranged heroes.',
      notes: '',
      attrib: '+ <span class="attribVal">45</span> <span class="attribValText">Strength</span><br />\n+ <span class="attribVal">500</span> <span class="attribValText">Health</span>',
      mc: false,
      cd: 7,
      lore: 'Preserved heart of an extinct monster, it bolsters the bearer\'s fortitude.',
      components: [ 'reaver', 'vitality_booster', 'vitality_booster' ],
      created: true },
   black_king_bar:
    { id: 116,
      ...
      qual: 'epic',
      cost: 3975,
      desc: '<h1>Active: Avatar</h1> Grants Spell Immunity and 100% Magic Damage Resistance.  Duration and cooldown decrease with each use. <br><br>Duration: 10 <br>Dispel Type: <span class="GameplayValues GameplayVariable">Basic Dispel</span>',
   ...
   aegis:
    { id: 117,
      ...
      qual: 'artifact',
      cost: 0,
      desc: '<h1>Passive: Reincarnation</h1> Brings you to life with full health and mana 5 seconds after you die, at the location where you died. <br><br>Reincarnation must be used within 5 minutes or Aegis of the Immortal disappears. If it expires, it will heal you over 5 seconds (dispels on damage).',
      notes: '',
      attrib: '',
      mc: false,
      cd: false,
   ...
   shivas_guard:
    { id: 119,
      ...
      qual: 'epic',
      cost: 4750,
      desc: '<h1>Active: Arctic Blast</h1> Emits a freezing wave that deals 200 magical damage to enemies and slows their movement by 40% for 4 seconds.<br><br>Radius: 900<br />\r\n<h1>Passive: Freezing Aura</h1> Reduces the attack speed of all enemies by 45. <br><br>Radius: 900',
   ...
   bloodstone:
    { id: 121,
      ...
      qual: 'epic',
      cost: 4900,
      desc: '<h1>Active: Pocket Deny</h1>Instantly causes you to die.<br><br>Must ground target to cast.  Cannot self cast.<br />\r\n<h1>Passive: Bloodpact</h1>Begins with 14 charges, and gains a charge each time an enemy hero dies within 1600 range. <br><br>Each charge grants 0.35 mana regeneration per second, and reduces respawn time by 3 seconds. <br><br>If the bearer dies, the Bloodstone loses a third of its charges.',
   ...
   lotus_orb:
    { id: 226,
      ...
      qual: 'epic',
      cost: 4000,
      desc: '<h1>Active: Echo Shell</h1>Applies a shield to the target unit for 6 seconds which re-casts most targeted spells back to their caster.<br><br>The shielded unit will still take damage from the spell. <br><br>Range: 900<br>Dispel Type: <span class="GameplayValues GameplayVariable">Basic Dispel</span>',
      notes: '',
   ...
   meteor_hammer:
    { id: 223,
      ...
      qual: 'epic',
      cost: 2625,
      desc: '<h1>Active: Meteor Hammer</h1> CHANNELED - After a successful channel, summons a meteor that strikes a 300 AoE, stunning enemies for 2 seconds and dealing impact damage. Continues to deal damage over time to enemies units and buildings for 6 seconds.<BR><BR>Building Impact Damage: 75 <BR>Building Over Time Damage: 50 <BR><BR>Non-Building Impact Damage: 150 <BR>Non-Building Over Time Damage: 90 <BR><BR>Channel Duration: 2.5 seconds.<BR>Landing Time: 0.5 seconds.',
      notes: '',
      ...
      components: [ 'ogre_axe', 'staff_of_wizardry', 'ring_of_regen', 'sobi_mask' ],
      created: true },
   nullifier:
    { id: 225,
      ...
      qual: 'epic',
      cost: 4700,
      desc: '<h1>Active: Nullify</h1> Dispels the target and mutes them for 5 seconds. Anytime the muted target is attacked, it will be slowed by 100% for 0.4 seconds.',
      notes: '',
   ...
   aeon_disk:
    { id: 256,
      img: 'aeon_disk_lg.png?3',
      dname: 'Aeon Disk',
      qual: 'epic',
      cost: 3350,
      desc: '<h1>Passive: Combo Breaker</h1> When you take damage and your health falls below 70%, a strong dispel is applied and you gain a 2.5 second buff that causes all damage you deal and are dealt to be reduced to zero. Only triggers on player based damage. <br />\r\n<br />\r\n<h1>Passive: Status Resistance</h1> Reduces status effect durations by 25%. ',
      notes: '',
   ...
   kaya:
    { id: 259,
      ...
      attrib: '+ <span class="attribVal">16</span> <span class="attribValText">Intelligence</span><br />\n+Spell Amplification <span class="attribVal">10%</span><br />\n+Manacost and Manaloss Reduction <span class="attribVal">10%</span>',
      mc: false,
      cd: false,
   ...
   trident:
    { id: 275,
      ...
      dname: 'DOTA_Tooltip_Ability_item_trident',
      qual: false,
      cost: null,
      desc: '',
      notes: '',
   ...
   combo_breaker:
    { id: 276,
      ...
      dname: 'DOTA_Tooltip_Ability_item_combo_breaker',
      qual: false,
      cost: null,
      desc: '',
      notes: '',
   ...
   refresher_shard:
    { id: 260,
      ...
      qual: 'consumable',
      cost: 1000,
      desc: '<h1>Use: Reset Cooldowns</h1>Resets the cooldowns of all your items and abilities.',
   ...
   spirit_vessel:
    { id: 267,
      ...
      qual: 'rare',
      cost: 2975,
      desc: '<h1>Active: Soul Release</h1> When used against enemies, it reduces health by 4.5% of current health per second, and reduces HP regeneration and healing by 70%. Deals 20 damage per second. <br><br>When used on allies, it increases health by 1% of current health per second, and increases HP regeneration and healing by 20%. Provides 35 health regeneration per second. <br><br>Lasts 8 seconds.  <br><br>Gains charges every time an enemy hero dies within 1400 units.  Only the closest Spirit Vessel to the dying hero will gain a charge.<br><br>Cast Range: 950 ',
      notes: '',
      attrib: '+ <span class="attribVal">250</span> <span class="attribValText">Health</span><br />\n+ <span class="attribVal">30</span> <span class="attribValText">Movement Speed</span><br />\n+ <span class="attribVal">1</span> <span class="attribValText">Mana Regeneration</span><br />\n+ <span class="attribVal">2</span> <span class="attribValText">All Attributes</span><br />\n+ <span class="attribVal">2</span> <span class="attribValText">Armor</span>',
      mc: false,
      cd: 7,
      lore: 'Forged by a god to entrap the soul of another.',
      components: [ 'urn_of_shadows', 'vitality_booster', 'wind_lace' ],
      created: true },
   vanguard:
    { id: 125,
      ...
      qual: 'epic',
      cost: 2150,
      desc: '<h1>Passive: Damage Block</h1> Grants a 50% chance to block 70 damage from incoming attacks on melee heroes, and 35 damage on ranged.',
      notes: 'Multiple sources of damage block don\'t stack.',
      attrib: '+ <span class="attribVal">250</span> <span class="attribValText">Health</span><br />\n+ <span class="attribVal">5.5</span> <span class="attribValText">HP Regeneration</span>',
      mc: false,
      cd: false,
   ...
   crimson_guard:
    { id: 242,
      ...
      qual: 'epic',
      cost: 3550,
      desc: '<h1>Active: Guard</h1> For 12 seconds, grant nearby allied heroes and buildings +2 armor, and a 100% chance to block 60 damage from each incoming attack.<br><br>Units may only be affected by Guard once every 46 seconds.<br><br>Radius: 900<br />\r\n<h1>Passive: Damage Block</h1> Grants a 50% chance to block 70 damage on melee heroes, and 35 damage on ranged.',
      notes: 'Multiple sources of damage block don\'t stack.',
   ...
   blade_mail:
    { id: 127,
      ...
      qual: 'epic',
      cost: 2200,
      desc: '<h1>Active: Damage Return</h1>For 4.5 seconds, duplicates any damage taken back to the unit that dealt the damage.',
   ...
   hood_of_defiance:
    { id: 131,
      ...
      qual: 'epic',
      cost: 1700,
      desc: '<h1>Active: Barrier</h1> Creates a spell shield that absorbs up to 325 magical damage.  Lasts 12 seconds.',
      notes: 'Stacks multiplicatively with other sources of spell resistance.',
   ...
   monkey_king_bar:
    { id: 135,
      ...
      qual: 'epic',
      cost: 4200,
      desc: '<h1>Passive: Pierce</h1>Grants each attack a 75% chance to pierce through evasion and deal 60 bonus pure damage.',
      notes: '',
      attrib: '+ <span class="attribVal">60</span> <span class="attribValText">Attack Speed</span>',
      mc: false,
      cd: false,
      lore: 'A powerful staff used by a master warrior.',
      components: [ 'hyperstone', 'javelin', 'javelin' ],
      created: true },
   radiance:
    { id: 137,
      ...
      qual: 'epic',
      cost: 5150,
      desc: '<h1>Toggle: Burn</h1> When active, scorches enemies for 60 damage per second, and causes them to miss 17% of their attacks.<br><br>Radius: 700',
      notes: '',
   ...
   butterfly:
    { id: 139,
      ...
      qual: 'epic',
      cost: 5525,
      desc: '<h1>Active: Flutter</h1> Grants 35% additional movement speed for 2 seconds.',
      notes: 'Stacks diminishingly with other sources of Evasion.',
   ...
   greater_crit:
    { id: 141,
      ...
      qual: 'epic',
      cost: 5320,
      desc: '<h1>Passive: Critical Strike</h1>Grants each attack a 30% chance to deal 235% damage.',
      notes: 'Critical Strike does not work against buildings.',
   ...
   basher:
    { id: 143,
      ...
      qual: 'epic',
      cost: 2700,
      desc: '<h1>Passive: Bash</h1> Grants melee heroes a 25% chance on hit to stun the target for 1.5 seconds and deal 100 bonus damage.  Bash pierces evasion. Bash chance for ranged heroes is 10%.',
      notes: 'Does not stack with other sources of Bash, however it will stack with Mini-Bash.<br />The following heroes cannot trigger Bash on this item: Spirit Breaker, Faceless Void, Slardar, and Troll Warlord.',
      attrib: '+ <span class="attribVal">10</span> <span class="attribValText">Strength</span>',
      mc: false,
      cd: 2,
   ...
   bfury:
    { id: 145,
      ...
      components: [ 'demon_edge', 'pers', 'quelling_blade' ],
      created: true },
   manta:
    { id: 147,
      img: 'manta_lg.png?3',
   ...
   lesser_crit:
    { id: 149,
      ...
      qual: 'epic',
      cost: 2120,
      desc: '<h1>Passive: Critical Strike</h1>Grants each attack a 20% chance to deal 175% damage.',
      notes: 'Critical Strike does not work against buildings.',
      attrib: '+ <span class="attribVal">30</span> <span class="attribValText">Damage</span>',
      mc: false,
      cd: false,
   ...
   dragon_lance:
    { id: 236,
      ...
      qual: 'artifact',
      cost: 1900,
      desc: '<h1>Passive: Dragon\'s Reach</h1> Increases attack range of ranged heroes by 140.',
      notes: 'Passive does not stack.',
   ...
   armlet:
    { id: 151,
      ...
      qual: 'epic',
      cost: 2370,
      desc: '<h1>Toggle: Unholy Strength</h1>When active, Unholy Strength grants +31 damage, +25 strength and +4 armor, but drains 54 health per second.<br><br> You cannot die from the health drain when Unholy Strength is activated, nor from the strength loss when Unholy Strength is deactivated.',
   ...
   invis_sword:
    { id: 152,
      ...
      qual: 'epic',
      cost: 2700,
      desc: '<h1>Active: Shadow Walk</h1>Makes you invisible for 14 seconds, or until you attack or cast a spell.  While Shadow Walk is active, you move 20% faster and can move through units.  <br><br>If attacking to end the invisibility, you gain 175 bonus damage on that attack.',
   ...
   silver_edge:
    { id: 249,
      ...
      qual: 'epic',
      cost: 5550,
      desc: '<h1>Active: Shadow Walk</h1>Makes you invisible for 14 seconds, or until you attack or cast a spell.  While invisible, you move 25% faster and can move through units.  <br><br>Attacking to end the invisibility will deal 175 bonus damage to the target, and for 4 seconds, disable their passive abilities.',
   ...
   satanic:
    { id: 156,
      ...
      qual: 'artifact',
      cost: 5500,
      desc: '<h1>Active: Unholy Rage</h1>Increases Lifesteal percentage to 200% for 5 seconds. <br />\r\n<h1>Passive: Lifesteal</h1>Heals the attacker for 25% of attack damage dealt.',
      notes: '',
      attrib: '+ <span class="attribVal">25</span> <span class="attribValText">Strength</span><br />\n+ <span class="attribVal">50</span> <span class="attribValText">Damage</span>',
      mc: false,
      cd: 35,
   ...
   mjollnir:
    { id: 158,
      ...
      qual: 'artifact',
      cost: 5700,
      desc: '<h1>Active: Static Charge</h1>Places a charged shield on a target unit for 15 seconds which has a 20% chance to release a 200 damage shocking bolt at a nearby attacker and 4 additional enemies.<br><br>Range: 800<br />\r\n<h1>Passive: Chain Lightning</h1>Grants a 25% chance on attack to release a bolt of electricity that leaps between 12 targets within a 900 radius, dealing 150 magical damage to each.',
   ...
   skadi:
    { id: 160,
      ...
      qual: 'artifact',
      cost: 5500,
      desc: '<h1>Passive: Cold Attack</h1> Attacks lower enemy attack speed by 45 and movement speed by 35%. <br><br>Lasts 5 seconds when used by melee heroes, and 2.5 seconds when used by ranged.',
   ...
   sange:
    { id: 162,
      ...
      qual: 'artifact',
      cost: 1950,
      desc: '<h1>Passive: Lesser Maim</h1>Each attack has a 30% chance to reduce enemy hero movement speed by 20% and attack speed by 20 when used by a melee hero. Reduces enemy hero movement by 10% and attack speed by 10 when used by a ranged hero. Effect lasts 5 seconds.',
      notes: '',
   ...
   helm_of_the_dominator:
    { id: 164,
      ...
      qual: 'artifact',
      cost: 2000,
      desc: '<h1>Active: Dominate</h1>Takes control of one neutral, non-ancient target unit and sets its movement speed to 425 and max health to a minimum of 1500.<br><br>Dominated units with a max health of greater than 1500 retain their original max health.  Dominated unit\'s bounty is set to 125 gold.<br><br>Range: 700<br />\r\n<h1>Passive: Dominator Aura</h1> Increases nearby allies\' attack speed by 20 and health regen by 8.<br><br>Radius: 900',
      ...
      attrib: '+ <span class="attribVal">2</span> <span class="attribValText">All Attributes</span><br />\n+ <span class="attribVal">5</span> <span class="attribValText">Attack Speed</span>',
      mc: false,
      cd: 60,
      lore: 'The powerful headpiece of a dead necromancer.',
      components: [ 'gloves', 'headdress', 'ring_of_health' ],
      created: true },
   maelstrom:
    { id: 166,
      ...
      qual: 'artifact',
      cost: 2800,
      desc: '<h1>Passive: Chain Lightning</h1>Grants a 25% chance on attack to release a bolt of electricity that leaps between 4 targets within a 900 radius, dealing 120 magical damage to each.',
      notes: '',
      attrib: '+ <span class="attribVal">24</span> <span class="attribValText">Damage</span><br />\n+ <span class="attribVal">25</span> <span class="attribValText">Attack Speed</span>',
      mc: false,
      cd: false,
   ...
   desolator:
    { id: 168,
      ...
      qual: 'artifact',
      cost: 3500,
      desc: '<h1>Passive: Corruption</h1> Your attacks reduce the target\'s armor by 6 for 15 seconds.',
   ...
   mask_of_madness:
    { id: 172,
      ...
      qual: 'artifact',
      cost: 1975,
      desc: '<h1>Active: Berserk</h1>Gives 110 attack speed and 12% movement speed, but reduces your armor by 8 and silences you.  Lasts 8 seconds.<br />\r\n<h1>Passive: Lifesteal</h1>Heals the attacker for 15% of attack damage dealt.',
      notes: '',
   ...
   ethereal_blade:
    { id: 176,
      ...
      qual: 'epic',
      cost: 4700,
      desc: '<h1>Active: Ether Blast</h1>Converts the target unit to ethereal form, rendering them immune to physical damage, but unable to attack and 40% more vulnerable to magic damage.  Lasts for 4 seconds on allies and 3 seconds on enemies.<br><br>  Enemy targets are also slowed by 80%, and take 2x your primary attribute + 75 as magical damage.<br><br>Range: 800',
   ...
   soul_ring:
    { id: 178,
      ...
      qual: 'common',
      cost: 770,
      desc: '<h1>Active: Sacrifice</h1> Consume 170 health to temporarily gain 150 mana.  Lasts 10 seconds.<br><br>If the mana gained cannot fit in your mana pool, it creates a buffer of mana that will be used before your mana pool.',
      notes: 'If this mana is not used before the duration ends, the extra mana is lost.',
      attrib: '+ <span class="attribVal">6</span> <span class="attribValText">Strength</span><br />\n+ <span class="attribVal">2</span> <span class="attribValText">HP Regeneration</span>',
      mc: false,
      cd: 25,
      lore: 'A ring that feeds on the souls of those who wear it.',
      components: [ 'ring_of_regen', 'gauntlets', 'gauntlets' ],
      created: true },
   arcane_boots:
    { id: 180,
      ...
      qual: 'rare',
      cost: 1400,
      desc: '<h1>Active: Replenish Mana</h1>Restores 135 mana to all nearby allies.<br>Flat movement speed bonuses from multiple pairs of boots do not stack.<br><br>Radius: 900',
   ...
   orb_of_venom:
    { id: 181,
      ...
      qual: 'component',
      cost: 275,
      desc: '<h1>Passive: Poison Attack</h1>Poisons the target, dealing 5 damage per second for 3 seconds and slowing movement 12% if the equipped hero is melee, or 4% if they are ranged.',
      notes: '',
      attrib: '',
      mc: false,
      cd: false,
   ...
   blight_stone:
    { id: 240,
      ...
      qual: 'component',
      cost: 300,
      desc: '<h1>Passive: Lesser Corruption</h1> Your attacks reduce the target\'s armor by 2 for 8 seconds.',
      notes: '',
      attrib: '',
      mc: false,
      cd: false,
   ...
   ancient_janggo:
    { id: 185,
      ...
      qual: 'rare',
      cost: 1615,
      desc: '<h1>Active: Endurance</h1> Gives +35 attack speed and +13% movement speed to nearby allies for 6 seconds. <br><br>Radius: 900<br />\r\n<h1>Passive: Swiftness Aura</h1>Gives 20 movement speed to nearby allies. <br><br>Radius: 900',
   ...
   medallion_of_courage:
    { id: 187,
      ...
      qual: 'rare',
      cost: 1175,
      desc: '<h1>Active: Valor</h1> If cast on an ally, grants them the 7 armor, and removing it from the caster. <br><br>If cast on an enemy, reduces 7 armor on both the enemy and the caster. <br><br>Cannot target magic immune enemies.<br><br>Range: 1000',
      notes: '',
      attrib: '+ <span class="attribVal">7</span> <span class="attribValText">Armor</span><br />\n+ <span class="attribVal">0.5</span> <span class="attribValText">Mana Regeneration</span>',
      mc: false,
      cd: 7,
   ...
   solar_crest:
    { id: 229,
      ...
      qual: 'rare',
      cost: 2625,
      desc: '<h1>Active: Shine</h1>When cast on an ally, grants them 10 armor and 20% evasion. When cast on an enemy, removes 10 of their armor and grants your allies 40% Accuracy on the target. <br><br>Removes the armor and evasion from the caster when used. <br><br> Cannot target magic immune enemies.<br><br>Range: 1000',
      notes: '',
      attrib: '+ <span class="attribVal">10</span> <span class="attribValText">Armor</span><br />\n+ <span class="attribVal">1</span> <span class="attribValText">Mana Regeneration</span><br />\n+ <span class="attribVal">20%</span> <span class="attribValText">Evasion</span>',
      mc: false,
      cd: 7,
   ...
   smoke_of_deceit:
    { id: 188,
      ...
      qual: 'consumable',
      cost: 80,
      desc: '<h1>Use: Disguise</h1> The user and all nearby allied player-controlled units in a 1025 radius gain Deceit and 15% bonus movement speed for 35 seconds. <br><br>Attacking, or moving within 1025 range of an enemy hero or tower, will break the invisibility. <br><br>Disguise grants invisibility that is immune to True Sight.',
      notes: '',
      attrib: '',
      mc: false,
      cd: 1,
   ...
   tome_of_knowledge:
    { id: 257,
      ...
      qual: 'consumable',
      cost: 150,
      desc: '<h1>Use: Enlighten</h1>Grants you 700 experience plus 135 per tome consumed by your team.<br><br>Tomes Used By Team: %customval_team_tomes_used%',
      notes: '',
      attrib: '',
      mc: false,
      cd: 0,
   ...
   veil_of_discord:
    { id: 190,
      ...
      qual: 'rare',
      cost: 2330,
      desc: '<h1>Active: Magic Weakness</h1> Cast a 600 radius blast that decreases enemy magic resistance by 25%.<br><br>Range: 1000<br>Duration: 16 seconds.',
      notes: '',
      attrib: '+ <span class="attribVal">5</span> <span class="attribValText">HP Regeneration</span><br />\n+ <span class="attribVal">6</span> <span class="attribValText">Armor</span><br />\n+ <span class="attribVal">6</span> <span class="attribValText">Agility</span><br />\n+ <span class="attribVal">6</span> <span class="attribValText">Strength</span><br />\n+ <span class="attribVal">14</span> <span class="attribValText">Intelligence</span>',
      mc: 50,
      cd: 20,
   ...
   guardian_greaves:
    { id: 231,
      ...
      qual: 'rare',
      cost: 5450,
      desc: '<h1>Active: Mend</h1>Restores 250 health and 160 mana to nearby allies, and removes most negative effects from the caster.<br><br>Radius: 900<br>Dispel Type: <span class="GameplayValues GameplayVariable">Basic Dispel</span><br />\r\n<h1>Passive: Guardian Aura</h1> Provides nearby allies with 3.5 health regeneration and 2 bonus armor. If an allied hero\'s health falls below 20%, they receive 12 health regeneration and 15 armor.<br />\r\nFlat movement speed bonuses from multiple pairs of boots do not stack.',
   ...
   iron_talon:
    { id: 239,
      ...
      qual: 'common',
      cost: 0,
      desc: '<h1>Active: Chop</h1>Targets a non-player enemy unit to remove 40% of its current HP.<br><br>If cast on a tree or ward, instantly destroys it.<br><br>Unit Range: 350<br>Tree Range: 350<BR>Ward Range: 450<br />\r\n<h1>Passive: Quell</h1>Increases attack damage against non-hero units by 24 for melee heroes, and 7 for ranged.',
   ...
   abyssal_blade:
    { id: 208,
      ...
      qual: 'epic',
      cost: 6400,
      desc: '<h1>Active: Overwhelm</h1> Stuns a target enemy unit for 2 seconds. <br><br>Pierces Spell Immunity.<br />\r\n<h1>Passive: Bash</h1> Grants melee heroes a 25% chance on hit to stun the target for 1.5 seconds and deal 100 bonus damage.  Bash pierces evasion. Bash chance for ranged heroes is 10%.<br />\r\n<h1>Passive: Damage Block</h1> Grants a 50% chance to block 70 damage from incoming attacks on melee heroes, and 35 damage on ranged.',
      notes: 'The stun is melee range.<br />Does not stack with other bashes.<br />The following heroes cannot trigger Bash on this item: Spirit Breaker, Faceless Void, Slardar, and Troll Warlord.',
   ...
   heavens_halberd:
    { id: 210,
      ...
      qual: 'artifact',
      cost: 3400,
      desc: '<h1>Active: Disarm</h1>Prevents a target from attacking for 3 seconds on melee targets, and 5 seconds on ranged targets.<br><br>Range: 600 <br />\r\n<h1>Passive: Lesser Maim</h1>Each attack has a 35% chance to reduce enemy hero movement speed by 20% and attack speed by 20 if the user is melee. Reduces enemy hero movement by 10% and attack speed by 10 if the user is ranged. Effect lasts 5 seconds.',
      notes: '',
      attrib: '+ <span class="attribVal">25%</span> <span class="attribValText">Evasion</span><br />\n+ <span class="attribVal">25</span> <span class="attribValText">Damage</span><br />\n+ <span class="attribVal">20</span> <span class="attribValText">Strength</span>',
      mc: 100,
      cd: 18,
   ...
   ring_of_aquila:
    { id: 212,
      ...
      qual: 'rare',
      cost: 965,
      desc: '<h1>Passive: Aquila Aura</h1>Grants 0.5 mana regeneration and 2 armor to nearby allies.<br><br>Radius: 900<br />\r\n<h1>Toggle: Aura</h1> Deactivate to stop affecting non-hero units.',
      notes: 'Does not stack with armor auras from Ring of Basilius or Ring of Aquila.<br />Multiple instances of Aquila Aura do not stack.',
   ...
   tranquil_boots:
    { id: 214,
      ...
      qual: 'rare',
      cost: 1050,
      desc: '<h1>Passive: Break</h1> Whenever you attack or are attacked, the bonus %bonus_health_health% HP regen is lost and the movement speed bonus is reduced to 65 for 13 seconds.<br><br>Flat movement speed bonuses from multiple pairs of boots do not stack.',
      notes: '',
      attrib: '+ <span class="attribVal">90</span> <span class="attribValText">Movement Speed</span><br />\n+ <span class="attribVal">13</span> <span class="attribValText">HP Regeneration</span>',
      mc: false,
      cd: 13,
   ...
   shadow_amulet:
    { id: 215,
      ...
      qual: false,
      cost: 1300,
      desc: '<h1>Active: Fade</h1>Grants invisibility to you or a target allied hero as long as target unit remains still.  <br><br>Has a 1.25 second fade time, and breaks instantly upon moving. <br><br>There is no cooldown when using this item on yourself.',
      notes: '',
      attrib: '+ <span class="attribVal">20</span> <span class="attribValText">Attack Speed</span>',
      mc: false,
      cd: 7,
   ...
   glimmer_cape:
    { id: 254,
      ...
      qual: 'rare',
      cost: 1850,
      desc: '<h1>Active: Glimmer</h1> After a 0.6 second delay, grants invisibility and 45% magic resistance to you or a target allied unit for 5 seconds.<br><br>Range: 800<br><br>Can be cast while channelling.',
      notes: '',
   ...
   river_painter2:
    { id: 1022,
      ...
      qual: 'component',
      cost: 0,
      desc: 'Pour this serum into the river to dry up the water for 15 minutes. <font color=\'#FF5555\'>Using this item on the river will permanently consume one charge from your Armory supply upon expiration of the effect . Charges do not get consumed if the effect is replaced by a stronger vial before expiration.</font> Vials can only be used if at least one charge remains in your Armory. Charges will only be used by successfully enchanting the river, and will not be consumed if the item is sold, dropped, or destroyed during a game. You can only cast a vial on the river if there\'s not a stronger vial already in effect.',
      notes: '',
      attrib: '',
      mc: false,
      cd: 0,
   ...
   river_painter3:
    { id: 1023,
      ...
      qual: 'component',
      cost: 0,
      desc: 'Pour this serum into the river to transform the water into a green slime for 15 minutes. <font color=\'#FF5555\'>Using this item on the river will permanently consume one charge from your Armory supply upon expiration of the effect. Charges do not get consumed if the effect is replaced by a stronger vial before expiration.</font> Vials can only be used if at least one charge remains in your Armory. Charges will only be used by successfully enchanting the river, and will not be consumed if the item is sold, dropped, or destroyed during a game. You can only cast a vial on the river if there\'s not a stronger vial already in effect.',
      notes: '',
      attrib: '',
      mc: false,
      cd: 0,
   ...
   river_painter4:
    { id: 1024,
      ...
      qual: 'component',
      cost: 0,
      desc: 'Pour this serum into the river to make the water oily for 15 minutes. <font color=\'#FF5555\'>Using this item on the river will permanently consume one charge from your Armory supply upon expiration of the effect. Charges do not get consumed if the effect is replaced by a stronger vial before expiration.</font> Vials can only be used if at least one charge remains in your Armory. Charges will only be used by successfully enchanting the river, and will not be consumed if the item is sold, dropped, or destroyed during a game. You can only cast a vial on the river if there\'s not a stronger vial already in effect.',
      notes: '',
      attrib: '',
      mc: false,
      cd: 0,
   ...
   river_painter5:
    { id: 1025,
      ...
      qual: 'component',
      cost: 0,
      desc: 'Pour this serum into the river to make the water electric for 15 minutes. <font color=\'#FF5555\'>Using this item on the river will permanently consume one charge from your Armory supply upon expiration of the effect. Charges do not get consumed if the effect is replaced by a stronger vial before expiration.</font> Vials can only be used if at least one charge remains in your Armory. Charges will only be used by successfully enchanting the river, and will not be consumed if the item is sold, dropped, or destroyed during a game. You can only cast a vial on the river if there\'s not a stronger vial already in effect.',
      notes: '',
      attrib: '',
      mc: false,
      cd: 0,
   ...
   river_painter6:
    { id: 1026,
      ...
      qual: 'component',
      cost: 0,
      desc: 'Pour this serum into the river to transform the water into a purple bubbling potion for 15 minutes. <font color=\'#FF5555\'>Using this item on the river will permanently consume one charge from your Armory supply upon expiration of the effect. Charges do not get consumed if the effect is replaced by a stronger vial before expiration.</font> Vials can only be used if at least one charge remains in your Armory. Charges will only be used by successfully enchanting the river, and will not be consumed if the item is sold, dropped, or destroyed during a game. You can only cast a vial on the river if there\'s not a stronger vial already in effect.',
      notes: '',
      attrib: '',
      mc: false,
      cd: 0,
   ...
   river_painter7:
    { id: 1027,
      ...
      qual: 'component',
      cost: 0,
      desc: 'Pour this serum into the river to transform the water into blood for 15 minutes. <font color=\'#FF5555\'>Using this item on the river will permanently consume one charge from your Armory supply upon expiration of the effect. Charges do not get consumed if the effect is replaced by a stronger vial before expiration.</font> Vials can only be used if at least one charge remains in your Armory. Charges will only be used by successfully enchanting the river, and will not be consumed if the item is sold, dropped, or destroyed during a game. You can only cast a vial on the river if there\'s not a stronger vial already in effect.',
      notes: '',
      attrib: '',
      mc: false,
      cd: 0,
